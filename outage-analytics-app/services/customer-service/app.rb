...
USERS = {
  'operator_jones' => { id: 'USR-001', name: 'Sarah Jones', email: 'sjones@genericutility.com', password_hash: Digest::SHA256.hexdigest('utility2026'), role: 'operator', region: 'Chicago-Metro', preferences: { theme: 'dark', timezone: 'America/Chicago', notifications: { email: true, sms: true, push: true } } },
  'engineer_chen' => { id: 'USR-002', name: 'David Chen', email: 'dchen@genericutility.com', password_hash: Digest::SHA256.hexdigest('utility2026'), role: 'engineer', region: 'Philadelphia-Metro', preferences: { theme: 'dark', timezone: 'America/New_York', notifications: { email: true, sms: false, push: true } } },
  'manager_smith' => { id: 'USR-003', name: 'Michael Smith', email: 'msmith@genericutility.com', password_hash: Digest::SHA256.hexdigest('utility2026'), role: 'manager', region: 'Baltimore-Metro', preferences: { theme: 'dark', timezone: 'America/New_York', notifications: { email: true, sms: true, push: true } } },
  'analyst_garcia' => { id: 'USR-004', name: 'Maria Garcia', email: 'mgarcia@genericutility.com', password_hash: Digest::SHA256.hexdigest('utility2026'), role: 'analyst', region: 'DC-Metro', preferences: { theme: 'dark', timezone: 'America/New_York', notifications: { email: true, sms: false, push: false } } },
  'dispatcher_lee' => { id: 'USR-005', name: 'James Lee', email: 'jlee@genericutility.com', password_hash: Digest::SHA256.hexdigest('utility2026'), role: 'dispatcher', region: 'Atlantic-Coast', preferences: { theme: 'dark', timezone: 'America/New_York', notifications: { email: true, sms: true, push: true } } },
}
