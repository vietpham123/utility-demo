...
USERS = {
  'operator_jones' => { id: 'USR-001', name: 'Sarah Jones', email: 'sjones@genericutility.com', password_hash: Digest::SHA256.hexdigest(ENV['DEMO_PASSWORD'] || 'changeme'), role: 'operator', region: 'Chicago-Metro', preferences: { theme: 'dark', timezone: 'America/Chicago', notifications: { email: true, sms: true, push: true } } },
  'engineer_chen' => { id: 'USR-002', name: 'David Chen', email: 'dchen@genericutility.com', password_hash: Digest::SHA256.hexdigest(ENV['DEMO_PASSWORD'] || 'changeme'), role: 'engineer', region: 'Philadelphia-Metro', preferences: { theme: 'dark', timezone: 'America/New_York', notifications: { email: true, sms: false, push: true } } },
  'manager_smith' => { id: 'USR-003', name: 'Michael Smith', email: 'msmith@genericutility.com', password_hash: Digest::SHA256.hexdigest(ENV['DEMO_PASSWORD'] || 'changeme'), role: 'manager', region: 'Baltimore-Metro', preferences: { theme: 'dark', timezone: 'America/New_York', notifications: { email: true, sms: true, push: true } } },
  'analyst_garcia' => { id: 'USR-004', name: 'Maria Garcia', email: 'mgarcia@genericutility.com', password_hash: Digest::SHA256.hexdigest(ENV['DEMO_PASSWORD'] || 'changeme'), role: 'analyst', region: 'DC-Metro', preferences: { theme: 'dark', timezone: 'America/New_York', notifications: { email: true, sms: false, push: false } } },
  'dispatcher_lee' => { id: 'USR-005', name: 'James Lee', email: 'jlee@genericutility.com', password_hash: Digest::SHA256.hexdigest(ENV['DEMO_PASSWORD'] || 'changeme'), role: 'dispatcher', region: 'Atlantic-Coast', preferences: { theme: 'dark', timezone: 'America/New_York', notifications: { email: true, sms: true, push: true } } },
  'supervisor_patel' => { id: 'USR-006', name: 'Arun Patel', email: 'apatel@genericutility.com', password_hash: Digest::SHA256.hexdigest(ENV['DEMO_PASSWORD'] || 'changeme'), role: 'supervisor', region: 'Delaware-Valley', preferences: { theme: 'dark', timezone: 'America/New_York', notifications: { email: true, sms: true, push: true } } },
  'technician_wong' => { id: 'USR-007', name: 'Emily Wong', email: 'ewong@genericutility.com', password_hash: Digest::SHA256.hexdigest(ENV['DEMO_PASSWORD'] || 'changeme'), role: 'technician', region: 'Chicago-Metro', preferences: { theme: 'dark', timezone: 'America/Chicago', notifications: { email: true, sms: true, push: false } } },
  'director_johnson' => { id: 'USR-008', name: 'Robert Johnson', email: 'rjohnson@genericutility.com', password_hash: Digest::SHA256.hexdigest(ENV['DEMO_PASSWORD'] || 'changeme'), role: 'director', region: 'DC-Metro', preferences: { theme: 'dark', timezone: 'America/New_York', notifications: { email: true, sms: true, push: true } } },
  'operator_brown' => { id: 'USR-009', name: 'Lisa Brown', email: 'lbrown@genericutility.com', password_hash: Digest::SHA256.hexdigest(ENV['DEMO_PASSWORD'] || 'changeme'), role: 'operator', region: 'Baltimore-Metro', preferences: { theme: 'dark', timezone: 'America/New_York', notifications: { email: true, sms: false, push: true } } },
  'engineer_martinez' => { id: 'USR-010', name: 'Carlos Martinez', email: 'cmartinez@genericutility.com', password_hash: Digest::SHA256.hexdigest(ENV['DEMO_PASSWORD'] || 'changeme'), role: 'engineer', region: 'Philadelphia-Metro', preferences: { theme: 'dark', timezone: 'America/New_York', notifications: { email: true, sms: true, push: false } } },
  'analyst_taylor' => { id: 'USR-011', name: 'Jessica Taylor', email: 'jtaylor@genericutility.com', password_hash: Digest::SHA256.hexdigest(ENV['DEMO_PASSWORD'] || 'changeme'), role: 'analyst', region: 'Atlantic-Coast', preferences: { theme: 'dark', timezone: 'America/New_York', notifications: { email: true, sms: false, push: true } } },
  'dispatcher_harris' => { id: 'USR-012', name: 'Kevin Harris', email: 'kharris@genericutility.com', password_hash: Digest::SHA256.hexdigest(ENV['DEMO_PASSWORD'] || 'changeme'), role: 'dispatcher', region: 'Chicago-Metro', preferences: { theme: 'dark', timezone: 'America/Chicago', notifications: { email: true, sms: true, push: true } } },
  'technician_clark' => { id: 'USR-013', name: 'Amanda Clark', email: 'aclark@genericutility.com', password_hash: Digest::SHA256.hexdigest(ENV['DEMO_PASSWORD'] || 'changeme'), role: 'technician', region: 'DC-Metro', preferences: { theme: 'dark', timezone: 'America/New_York', notifications: { email: false, sms: true, push: true } } },
  'manager_lewis' => { id: 'USR-014', name: 'Thomas Lewis', email: 'tlewis@genericutility.com', password_hash: Digest::SHA256.hexdigest(ENV['DEMO_PASSWORD'] || 'changeme'), role: 'manager', region: 'Delaware-Valley', preferences: { theme: 'dark', timezone: 'America/New_York', notifications: { email: true, sms: false, push: false } } },
  'operator_robinson' => { id: 'USR-015', name: 'Nicole Robinson', email: 'nrobinson@genericutility.com', password_hash: Digest::SHA256.hexdigest(ENV['DEMO_PASSWORD'] || 'changeme'), role: 'operator', region: 'Baltimore-Metro', preferences: { theme: 'dark', timezone: 'America/New_York', notifications: { email: true, sms: true, push: true } } },
}
